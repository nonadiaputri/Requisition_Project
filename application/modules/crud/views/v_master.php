  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?=base_url();?><?php echo ucfirst($this->uri->segment(1));?>"><?php echo ucfirst($this->uri->segment(1));?></a></li>
...
<!-- END OF FOOTER SECTION-->
  ...
  <!-- <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">KG Media</a>.</strong> All rights
    reserved.
  </footer> -->
