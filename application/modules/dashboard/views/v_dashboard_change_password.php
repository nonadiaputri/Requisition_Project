...
<?php echo $sidebar;?>
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?= base_url(); ?>dashboard/pwd_encryption" method="post">
              <div class="box-body">
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>assets/dist/css/kompas-intranet.css" />
        ...
        <!--- FOOTER SECTION --->
        <div class="no-break">
            <footer id="footer" class="footer-wrapper application no-print" style="margin-left:auto">
                <div class="container">
                    <div class="row">
